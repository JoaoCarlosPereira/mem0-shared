...
export default {
  ...
  translation: {
    common: {
      ...
      aboutPlanka_title: 'Sobre o Kanban',
      ...
      discoverPlankaPro: '✨ Mais recursos para seus quadros',
      discoverPlankaPro_title: 'Mais recursos',
      ...
      plankaUsesAppriseToSendNotificationsToOver100PopularServices:
        'Kanban usa <1><0>Apprise</0></1> para enviar notificações para mais de 100 serviços populares.',
      port: 'Porta',
    ...
    action: {
      ...
      archiveCards_title: 'Arquivar cartões',
      archiveProject: 'Arquivar quadro',
      ...
      unarchiveProject: 'Desarquivar quadro',
